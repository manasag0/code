...
function numOfWays(elements, key, noOfElements, currentSum,currentIndex,taken){
//basecase
...
ways += numOfWays(elements,key, noOfElements,currentIndex,currentSum+elements[currentIndex],0)
